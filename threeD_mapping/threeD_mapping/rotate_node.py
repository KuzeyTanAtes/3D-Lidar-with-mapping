...
class Feedback(Node):
    ...
    def __init__(self):
        ...
        self.odomReader = self.create_subscription(
            Odometry, "/odom", self.sub_callback, 10
        )
        self.odomReader
    ...
    def sub_callback(self, msgReceived: Odometry):
        ...
        quat = [
            msgReceived.pose.pose.orientation.x,
            msgReceived.pose.pose.orientation.y,
            msgReceived.pose.pose.orientation.z,
            msgReceived.pose.pose.orientation.w,
        ]
